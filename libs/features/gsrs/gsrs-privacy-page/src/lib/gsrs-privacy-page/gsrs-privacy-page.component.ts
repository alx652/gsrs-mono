...
@Component({
  ...
  templateUrl: './gsrs-privacy-page.component.html',
  styleUrl: './gsrs-privacy-page.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class GsrsPrivacyPageComponent implements OnInit {
